...
export default function Card(props) {
  ...
  const handleUpdateProduct = async () => {
    try {
      ...
      await axios.put(`${process.env.REACT_APP_BASE_URL}/api/foodItem/update/${props.foodItem._id}`, updatedProduct);
  ...
  const handleDeleteProduct = async () => {
    if (window.confirm("Are you sure you want to delete this product?")) {
      try {
        await axios.delete(`${process.env.REACT_APP_BASE_URL}/api/foodItem/delete/${props.foodItem._id}`);
